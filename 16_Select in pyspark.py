...
# MAGIC %md
# MAGIC # 16_Select in pyspark

# COMMAND ----------

# MAGIC %md
# MAGIC Write a pyspark code perform below function:
# MAGIC  * Write a pyspark code to get all employee detail. 
# MAGIC  * Write a query to get only "FirstName" column from emp_df 
# MAGIC  * Write a Pyspark code to get FirstName in upper case as "First Name". 
# MAGIC  * Write a pyspark code to get FirstName in lower case
...
df_data.select('First_Name').show()

# COMMAND ----------

df_data.select(upper(col('First_Name'))).show()

# COMMAND ----------

df_data.select(lower(col('First_Name'))).show()
